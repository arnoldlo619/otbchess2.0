...
The audit found **11 already compliant or invoker-only files** and **45 custom-overlay files with at least one confirmed keyboard gap**. The shared stack-aware focus-management hook now covers four principal public/participant overlays and nine tournament-director operational overlays.

| Category | Count | Status |
|---|---:|---|
| Audited overlay-related files | 56 | Complete |
| Already compliant/invoker-only | 11 | No change required |
| Custom overlays migrated | 13 | Complete |
| Remaining custom-overlay files | 32 | Open |
...
`ArchivePasswordModal.tsx`, `AvatarNavDropdown.tsx`, `ChessLineViewer.tsx`, `ClubMeetupWizard.tsx`, `ClubShareModal.tsx`, `ContactOwnerModal.tsx`, `CreateClubAuthGate.tsx`, `CreateClubWizard.tsx`, `CreateLeagueWizard.tsx`, `EditClubDetailsModal.tsx`, `FilmGameSheet.tsx`, `FullScreenClock.tsx`, `InstallBanner.tsx`, `NotationModeOverlay.tsx`, `QRModal.tsx`, `RegisterGameModal.tsx`, `SpectatorQRScreen.tsx`, `SpectatorShareModal.tsx`, `TiebreakTooltip.tsx`, `TournamentWizard.tsx`, `club/ClubPromoModal.tsx`, `club/ClubQRProjectionModal.tsx`, `BroadcastConsole.tsx`, `BroadcastControl.tsx`, `ChessClock.tsx`, `ClubDashboard.tsx`, `ClubProfile.tsx`, `Director.tsx`, `Join.tsx`, `MyClubs.tsx`, `PlayerView.tsx`, and `RepertoireBuilder.tsx`.
