...
export const dbClubs = mysqlTable(
  "clubs",
  {
    ...
    silkSpeed: float("silk_speed"),
    silkColor: varchar("silk_color", { length: 20 }),
    silkNoise: float("silk_noise"),
    ...
    linktree: varchar("linktree", { length: 300 }),
    contactEmail: varchar("contact_email", { length: 200 }),
    contactPhone: varchar("contact_phone", { length: 50 }),
    meetingSchedule: varchar("meeting_schedule", { length: 20 }).notNull().default("weekly"),
    meetingDay: varchar("meeting_day", { length: 20 }),
    meetingTime: varchar("meeting_time", { length: 10 }),
    meetingNotes: text("meeting_notes"),
    joinPolicy: varchar("join_policy", { length: 20 }).notNull().default("public"),
    intakeQuestions: text("intake_questions"),
    status: varchar("status", { length: 20 }).notNull().default("published"),
    announcement: text("announcement"),
    // Landing page extended fields
    facebook: varchar("facebook", { length: 300 }),
    xUrl: varchar("x_url", { length: 300 }),
    meetupUrl: varchar("meetup_url", { length: 300 }),
    whatsapp: varchar("whatsapp", { length: 300 }),
    groupme: varchar("groupme", { length: 300 }),
    beginnerFriendly: tinyint("beginner_friendly").notNull().default(0),
    isVerified: tinyint("is_verified").notNull().default(0),
    isClaimed: tinyint("is_claimed").notNull().default(0),
    ...
    newMembersThisMonth: int("new_members_this_month").notNull().default(0),
