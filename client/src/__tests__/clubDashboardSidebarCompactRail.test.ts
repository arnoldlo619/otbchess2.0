...
describe("Club Dashboard compact sidebar rail", () => {
  ...
  it("crossfades the compact mark into a restrained, left-aligned supplied wordmark without changing its accessible back-to-clubs action", () => {
    ...
    expect(sidebarSource).toContain('className="absolute h-12 w-[112px] object-contain mix-blend-screen');
