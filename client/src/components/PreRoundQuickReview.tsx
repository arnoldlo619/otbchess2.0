...
export function PreRoundQuickReview({
  ...
  const subText = isDark ? "text-white/55" : "text-[#436850]";
  const bodyText = isDark ? "text-white/80" : "text-[#12372A]/85";
  ...
  const lineBg = isDark
    ...
    : "bg-white border border-[#ADBC9F]/70";
  const monoText = isDark ? "text-[#5B9A6A]" : "text-[#436850]";
                ...
                <div className="flex items-start justify-between gap-2 mb-2">
                  ...
                  {topLine.eco && (
                    <span className={`text-[10px] font-mono px-1.5 py-0.5 rounded-md shrink-0 ${
                      isDark ? "bg-[#436850]/15 text-[#5B9A6A]" : "bg-[#436850]/08 text-[#436850]"
                    }`}>
                      {topLine.eco}
                    </span>
                  )}
