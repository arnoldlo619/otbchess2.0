...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    function render(now: number) {
      ...
      resizeCanvas()
      // gl and canvas are guaranteed non-null here (we returned early above if gl was null)
      const _gl = gl!
      const _canvas = canvas!
      _gl.uniform4f(uni.scene, _canvas.width, _canvas.height, ((now - start) / 1000) * UNIFORMS.timeScale, UNIFORMS.colorCount)
      _gl.uniform4f(uni.space, UNIFORMS.offsetX, UNIFORMS.offsetY, mouseX, mouseY)
      _gl.uniform4f(uni.cursor, UNIFORMS.cursorEnabled ? cursorPresence : 0, UNIFORMS.cursorEffect, UNIFORMS.cursorStrength, UNIFORMS.cursorRadius)
