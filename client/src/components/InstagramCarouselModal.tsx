      ...
      <div style={{ position: "absolute", top: isStory ? PAD * 1.5 : PAD, left: PAD, right: PAD }}>
        ...
        <div
          style={{
            ...
            color: headingColor,
            lineHeight: 0.95,
            letterSpacing: headingFont.id === "anton" ? "0.02em" : "-0.02em",
            textTransform: "uppercase" as const,
          }}
        >
          {tournamentName}
      ...
      {displayRows.map((row, idx) => {
        ...
        return (
          ...
          >
            ...
            {/* ELO — up from 18 → 22 */}
            <div style={{ width: 90 * s, textAlign: "right", fontSize: isStory ? 28 * s : 24 * s, color: "rgba(255,255,255,0.52)", fontWeight: 600 }}>
              {row.player.elo}
            </div>
            ...
            {/* W-D-L — up from 14 → 18 */}
            <div style={{ width: 90 * s, textAlign: "right", fontSize: isStory ? 22 * s : 20 * s, color: "rgba(255,255,255,0.42)", fontWeight: 700 }}>
      ...
      <div style={{ padding: `0 ${PAD}px`, display: "flex", flexDirection: "column" as const, gap: isStory ? 20 * s : 14 * s }}>
        ...
        {isStory && rows.length > 0 && (
          <>
            ...
            >
              <div style={{ fontSize: 20 * s, color: "rgba(255,255,255,0.45)", fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase" as const }}>
                Champion
              </div>
              <div style={{ fontSize: 30 * s, fontWeight: 900, color: BRAND.white }}>
                {rows[0].player.name}{" "}
      ...
      >
        ...
        <div
          style={{
            ...
            color: headingColor,
            lineHeight: 0.95,
            letterSpacing: headingFont.id === "anton" ? "0.02em" : "-0.03em",
          ...
          {runnerUp && (
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontSize: isStory ? 24 * s : 20 * s, color: "rgba(255,255,255,0.38)", marginTop: 4 * s }}>
              ...
              {semifinalists.slice(0, 2).map((p) => (
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ fontSize: isStory ? 20 * s : 16 * s, color: "rgba(255,255,255,0.35)", marginTop: 3 * s }}>
                      {p.elo} ELO
                    </div>
                  </div>
                </div>
    ...
    >
      <div
        className={`relative flex flex-col rounded-2xl overflow-hidden shadow-2xl w-full max-w-2xl max-h-[95dvh] ${
          isDark ? "bg-[#0F1F13] border border-white/10" : "bg-white border border-[#ADBC9F]"
        }`}
      >
        {/* Header */}
        <div className={`flex items-center justify-between px-5 py-4 border-b flex-shrink-0 ${isDark ? "border-white/08" : "border-[#ADBC9F]/70"}`}>
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className={`text-sm font-bold ${isDark ? "text-white" : "text-[#12372A]"}`}>Instagram Carousel</h2>
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="flex flex-col items-center gap-4 p-5">
            ...
            {/* ── Format Toggle ── */}
            <div className={`w-full rounded-2xl border p-1 flex gap-1 ${isDark ? "border-white/08 bg-white/03" : "border-[#ADBC9F] bg-[#FBFADA]/70"}`}>
              <button
              ...
              <button
                ...
                className={`w-8 h-8 rounded-lg flex items-center justify-center transition-colors ${
                  isDark
                    ...
                    : "bg-[#ADBC9F]/40 hover:bg-[#ADBC9F] text-[#436850] disabled:opacity-30"
                }`}
              >
                    ...
                    <div
                      className={`rounded-full transition-all ${
                        idx === activeSlide
                          ...
                          : "w-2 h-2 bg-[#ADBC9F] hover:bg-[#436850]/50"
                      }`}
                    />
                    <span className={`text-[10px] font-medium transition-colors ${
                      idx === activeSlide
                        ? "text-[#436850]"
                        : isDark ? "text-white/30 group-hover:text-white/50" : "text-[#436850]/70 group-hover:text-[#436850]"
                    }`}>
                      {slide.label}
                    </span>
                  </button>
            ...
            <div className={`w-full rounded-2xl border p-4 ${isDark ? "border-white/08 bg-white/03" : "border-[#ADBC9F] bg-[#FBFADA]/70"}`}>
              <div className="flex items-center justify-between mb-3">
                <div>
                  <p className={`text-xs font-bold ${isDark ? "text-white/70" : "text-[#12372A]/85"}`}>Club / Host Logo</p>
              ...
              {hostLogoUrl ? (
                <div className="flex items-center gap-3">
                  <div className={`rounded-xl overflow-hidden border p-2 flex items-center justify-center ${isDark ? "border-white/10 bg-white/05" : "border-[#ADBC9F] bg-white"}`} style={{ width: 72, height: 48 }}>
                    <img src={hostLogoUrl} alt="Host logo" className="max-w-full max-h-full object-contain" />
                  </div>
                  <div>
                    <p className={`text-xs font-semibold ${isDark ? "text-white/70" : "text-[#12372A]/85"}`}>Logo uploaded</p>
                    <button onClick={() => logoInputRef.current?.click()} className={`text-[10px] mt-0.5 ${isDark ? "text-[#769656] hover:text-[#4CAF50]" : "text-[#436850] hover:text-[#2A4A32]"}`}>
                      Change image
                    </button>
                  </div>
                </div>
                ...
                {ALL_THEMES.map((t) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className={`text-[10px] font-semibold leading-none transition-colors ${isActive ? isDark ? "text-white/80" : "text-[#12372A]" : isDark ? "text-white/35" : "text-[#436850]"}`}>
                        {t.label}
                      </span>
                    </button>
                  );
            ...
            {/* Mobile share hint */}
            {canShare && (
              <p className={`text-[11px] text-center ${isDark ? "text-white/25" : "text-[#436850]"}`}>
        ...
        {exporting && exportProgress > 0 && (
          <div className={`px-5 py-2 flex-shrink-0 ${isDark ? "bg-white/03" : "bg-[#FBFADA]/70"}`}>
            <div className={`h-1 rounded-full overflow-hidden ${isDark ? "bg-white/10" : "bg-[#ADBC9F]"}`}>
              <div className="h-full bg-[#436850] transition-all duration-300 rounded-full" style={{ width: `${exportProgress}%` }} />
            </div>
            <p className={`text-xs mt-1 text-center ${isDark ? "text-white/40" : "text-[#436850]"}`}>
        ...
        {/* Footer actions */}
        <div className={`flex items-center gap-3 px-5 py-4 border-t flex-shrink-0 ${isDark ? "border-white/08" : "border-[#ADBC9F]/70"}`}>
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold transition-colors flex-1 justify-center ${
              isDark
                ...
                : "bg-[#ADBC9F]/40 hover:bg-[#ADBC9F] text-[#12372A]/85 border border-[#ADBC9F]"
            } disabled:opacity-50`}
          >
            {exporting
          ...
          <button
            ...
            style={{ background: exporting ? "#2A4A32" : "linear-gradient(135deg, #436850 0%, #2A4A32 100%)" }}
          >
