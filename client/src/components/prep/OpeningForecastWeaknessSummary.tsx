  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        <h4 className={`text-[11px] font-bold uppercase tracking-[0.12em] ${t.textPrimary}`}>Opening weakness read</h4>
        {isAiGenerated && <span className={`rounded-full px-1.5 py-0.5 text-[9px] font-bold ${isDark ? "bg-[#5B9A6A]/15 text-[#8dcc9b]" : "bg-[#436850]/10 text-[#436850]"}`}>Evidence-based</span>}
      </div>
      {loading ? (
