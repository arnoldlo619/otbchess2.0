        ...
        <AnimatePresence>
          {open && panelPos && (
            ...
            {user && !user.isGuest && hasSparkline && (
              ...
              >
                <p className={`text-[9px] font-semibold uppercase tracking-widest mb-1.5 ${isDark ? "text-white/25" : "text-[#436850]"}`}>
                  Rating History
                </p>
                  ...
                  {([
                    ...
                    return (
                      <div key={label} className="flex items-center gap-2">
                        {/* Format label */}
                        <span className={`text-[10px] w-10 flex-shrink-0 flex items-center gap-0.5 ${isDark ? "text-white/35" : "text-[#436850]"}`}>
                          <span>{icon}</span>
            ...
            <div className="px-2 pt-1.5 pb-1">
              <p className={`px-2 pb-1 text-[10px] font-semibold uppercase tracking-widest ${isDark ? "text-white/30" : "text-[#436850]"}`}>
                Navigate
              </p>
            ...
            <div className="px-2 pb-2">
              {user && !user.isGuest && (
                <Link
                  href="/profile"
                  onClick={() => setOpen(false)}
                  className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-colors ${isDark ? "text-white/65 hover:text-white" : "text-[#436850] hover:text-[#12372A]"}`}
                  style={{ border: "1px solid transparent" }}
                  onMouseEnter={(e) =>
                    ((e.currentTarget as HTMLElement).style.background =
                      isDark ? "rgba(255,255,255,0.07)" : "var(--dropdown-item-hover-bg)")
            ...
            <>
              ...
              {user && !user.isGuest && (
                <div className="flex items-center gap-3 px-5 pt-2 pb-3">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-1.5 flex-wrap">
                      <p className={`text-sm font-semibold truncate ${isDark ? "text-white" : "text-[#12372A]"}`}>
                        {user.displayName || user.email}
                      </p>
                      {user.isStaff && (
                        <span className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-full bg-amber-500/15 border border-amber-500/30 text-amber-400 text-[9px] font-bold tracking-wider uppercase flex-shrink-0">
                    ...
                    {user.chesscomUsername && (
                      <p className={`text-[11px] truncate ${isDark ? "text-white/40" : "text-[#436850]"}`}>
                        chess.com/{user.chesscomUsername}
                      </p>
                    )}
                  </div>
              ...
              <div className="px-3 pb-1">
                <p className={`px-2 pb-1.5 text-[10px] font-semibold uppercase tracking-widest ${isDark ? "text-white/30" : "text-[#436850]"}`}>
                  Navigate
                </p>
              ...
              <div className="px-3 pb-1">
                <button
                  onClick={() => toggleTheme?.()}
                  className={`flex items-center gap-3 w-full px-3 py-3 rounded-xl text-sm font-semibold transition-colors ${isDark ? "text-white/65 hover:text-white" : "text-[#436850] hover:text-[#12372A]"}`}
                  style={{ border: "1px solid transparent" }}
                >
                  <div className="w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: isDark ? "rgba(255,255,255,0.06)" : "var(--dropdown-icon-bg)" }}>
                    {isDark ? <Sun className="w-4 h-4 text-white/50" /> : <Moon className="w-4 h-4 text-[#436850]" />}
                  </div>
                  <span>{isDark ? "Light Mode" : "Dark Mode"}</span>
                  <div
              ...
              <div className="px-3 pb-3">
                {user && !user.isGuest && (
                  <Link
                    href="/profile"
                    onClick={() => setOpen(false)}
                    className={`flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-semibold transition-colors ${isDark ? "text-white/65 hover:text-white" : "text-[#436850] hover:text-[#12372A]"}`}
                    style={{ border: "1px solid transparent" }}
                  >
                    <div className="w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: isDark ? "rgba(255,255,255,0.06)" : "var(--dropdown-icon-bg)" }}>
                      <Crown className={`w-4 h-4 ${isDark ? "text-white/50" : "text-[#436850]"}`} />
                    </div>
                    <span>My Profile</span>
                  </Link>
                )}
