    ...
    >
        ...
        return (
          <div className="p-3">
            <a
              ...
              className="flex items-center gap-3 p-3 rounded-xl border border-[#4CAF50]/25 bg-[#436850]/15 hover:bg-[#436850]/25 transition-all group active:scale-[0.98]"
            >
              {/* Role icon */}
              ...
              <li key={`${entry.role}-${entry.id}`}>
                ...
                >
                  <div className={`flex-shrink-0 w-7 h-7 rounded-lg flex items-center justify-center ${
                    entry.role === "director" ? "bg-[#436850]/30 text-[#4CAF50]" : "bg-white/08 text-white/40"
                  }`}>
      ...
      <div className="border-t border-white/08">
        <button
          ...
          className="w-full flex items-center gap-2 px-4 py-2.5 text-xs font-semibold text-[#4CAF50] hover:bg-[#436850]/15 transition-colors"
        >
