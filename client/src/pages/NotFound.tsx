    ...
    >
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-16">
        <div className="text-center max-w-md">
          ...
          <h1
            className={`text-4xl font-bold tracking-tight mb-3 ${isDark ? "text-white" : "text-[#1A1A1A]"}`}
            style={{ fontFamily: "'Clash Display', sans-serif" }}
          >
            This board is empty.
          </h1>
          <p className={`text-base mb-8 leading-relaxed ${isDark ? "text-white/70" : "text-[#6B6B50]"}`}>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button
              onClick={() => setLocation("/")}
              className="flex items-center justify-center gap-2 px-6 py-3 bg-[#4D6940] text-white text-sm font-semibold rounded-xl hover:bg-[#2A4A32] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg shadow-[#4D6940]/30"
              style={{ fontFamily: "'Clash Display', sans-serif" }}
            >
          ...
          {/* Quick links */}
          <div className={`mt-10 pt-8 border-t ${isDark ? "border-white/08" : "border-[#E8D9B0]/70"}`}>
            <p className={`text-xs font-semibold uppercase tracking-widest mb-4 ${isDark ? "text-white/55" : "text-[#6B6B50]"}`}>
              Quick links
            </p>
