          ...
          <div className="rounded-xl border border-white/08 bg-[oklch(0.14_0.04_145)] p-4 space-y-3">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 rounded bg-white flex items-center justify-center text-[10px] font-bold text-gray-900">W</div>
              ...
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 rounded bg-gray-800 flex items-center justify-center text-[10px] font-bold text-white">B</div>
