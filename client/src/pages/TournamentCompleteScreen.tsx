...
function GuestAccountPrompt({
  ...
  const border = isDark ? "border-[#4CAF50]/25" : "border-[#436850]/20";
      ...
      <div className="mx-4 mt-5">
        <div className={`rounded-2xl border ${border} ${cardBg} p-5`}>
          <div className="flex items-start gap-3">
            <div className="w-10 h-10 bg-[#436850] rounded-xl flex items-center justify-center flex-shrink-0 shadow-md shadow-[#436850]/25">
          ...
          <div className="flex gap-2.5 mt-4">
            <button
              onClick={openSignup}
              className="flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl bg-[#436850] text-white text-sm font-bold"
            >
    ...
    <div className={`min-h-screen ${bg} flex flex-col`}>
      ...
      <div className="px-4 pb-safe-bottom pb-8 pt-5 mt-auto">
        <Link
          ...
          className="flex items-center justify-center gap-2 w-full py-4 rounded-2xl font-bold text-base bg-[#436850] text-white"
        >
