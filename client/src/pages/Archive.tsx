  ...
  return (
    <div className={`rounded-2xl border overflow-hidden ${
      ...
      <div className="flex gap-2 px-5 pb-4">
        <Link
          href={`/tournament/${config.id}/manage`}
          className={`flex-1 w-full flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold transition-colors ${
        ...
        <Link
          href={`/tournament/${config.id}/report`}
          className={`flex-1 w-full flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold transition-colors ${
    ...
    >
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 space-y-8">
        ...
        >
          ...
          <Link href="/tournaments/new" className="inline-flex px-5 py-2.5 rounded-xl bg-[#436850] text-white text-sm font-semibold hover:bg-[#3a5230] transition-colors">
            Create Tournament →
          </Link>
        </motion.div>
      </div>
