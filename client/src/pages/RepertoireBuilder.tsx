      ...
      <div className="flex flex-wrap items-center gap-1 text-sm">
        <button
          ...
          className={`px-1.5 py-0.5 rounded text-xs font-mono ${
            isDark ? "bg-white/5 hover:bg-white/10 text-white/60" : "bg-[#ADBC9F]/40 hover:bg-[#ADBC9F] text-[#436850]"
          }`}
        >
          Start
        </button>
        {moves.map((node, i) => {
          ...
          return (
            <React.Fragment key={node.fen}>
              <span className={isDark ? "text-white/30" : "text-[#436850]/70"}>/</span>
              <button
    ...
    <div
      ...
      className={`flex items-center gap-3 px-3 py-3 rounded-lg cursor-pointer transition-all group ${
        isInRepertoire
          ...
          : "hover:bg-[#FBFADA] border border-transparent"
      }`}
      onClick={onPlay}
    >
      {/* Move SAN */}
      ...
      <div className="w-24 shrink-0">
        <div className="flex h-2 rounded-full overflow-hidden">
          ...
          <div className="bg-[#436850]/60" style={{ width: `${drawPct}%` }} />
          <div className="bg-[#12372A]" style={{ width: `${lossPct}%` }} />
        </div>
      </div>
...
export default function RepertoireBuilder() {
  ...
  return (
    <div className={`h-screen flex flex-col overflow-hidden ${isDark ? "bg-[#0d1a0f] text-white" : "bg-[#FBFADA]/70 text-[#12372A]"}`}>
      {/* ── Header ──────────────────────────────────────────────────────────── */}
      <div
        ...
        <div className="flex items-center gap-3 w-full">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className={`text-xs px-2 py-0.5 rounded-full ${
              color === "white"
                ? "bg-white text-[#12372A] border border-[#ADBC9F]"
                : "bg-[#12372A] text-white border border-[#436850]/40"
            }`}>
            ...
            {quizStatus === "wrong" && (
              <button
                ...
                className={`flex items-center gap-1 text-xs px-2 py-1 rounded-lg ${
                  isDark ? "text-white/60 hover:text-white hover:bg-white/10" : "text-[#436850] hover:text-[#12372A] hover:bg-[#ADBC9F]/50"
                }`}
              >
                <SkipForward size={13} />
                Skip
        ...
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 h-full">
            ...
            <div className="flex-1 flex flex-col" ref={boardContainerRef}>
              ...
              <div className="flex items-center justify-between mt-3">
                ...
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className={`p-2 rounded-lg transition ${isDark ? "hover:bg-white/10 text-white/60" : "hover:bg-[#ADBC9F] text-[#436850]"}`}
              ...
              {showEngine && sfEval && (
                <div className={`mt-2 text-sm flex flex-wrap items-center gap-x-2 gap-y-1 ${isDark ? "text-white/60" : "text-[#436850]"}`}>
                  ...
                  {sfEval.bestMove && (
                    <span className={`font-mono ${isDark ? "text-white/60" : "text-[#436850]"}`}>
              ...
              {quizStatus === "idle" && (
                <div className={`mt-3 rounded-xl border ${
                  isDark ? "bg-[#0f1f12]/60 border-white/10" : "bg-[#FBFADA]/70 border-[#ADBC9F]"
                }`}>
                  {/* Header */}
          ...
          {quizStatus !== "idle" && quizStatus !== "complete" ? (
            ...
            <div className={`w-full lg:w-[45%] lg:sticky lg:top-20 rounded-2xl border ${
              isDark ? "bg-[#0f1f12]/50 border-purple-500/20" : "bg-[#F0F5E8] border-purple-200"
            } overflow-hidden`}>
              ...
              <div className="px-4 py-4">
                <div className="grid grid-cols-3 gap-3 mb-4">
                  ...
                  <div className={`rounded-xl p-3 text-center ${
                    isDark ? "bg-white/5 border border-white/10" : "bg-[#FBFADA]/70 border border-[#ADBC9F]/70"
                  }`}>
                    <div className={`text-2xl font-bold ${
                      isDark ? "text-white/80" : "text-[#12372A]/85"
                    }`}>{quizTotal}</div>
                    <div className={`text-[11px] mt-0.5 ${
                      isDark ? "text-white/40" : "text-[#436850]"
                    }`}>Attempts</div>
            ...
            /* ── Explorer Panel ── */
          <div className={`w-full lg:w-[45%] lg:sticky lg:top-20 rounded-2xl border ${
            isDark ? "bg-[#0f1f12]/50 border-white/10" : "bg-[#F0F5E8] border-[#ADBC9F]"
          } overflow-hidden`}>
            {/* Panel header with tab switcher */}
            <div className={`px-4 pt-3 pb-0 border-b ${isDark ? "border-white/10" : "border-[#ADBC9F]/70"}`}>
            ...
            {rightTab === "explorer" && coverage && (
              <div className={`px-4 py-3 border-b ${
                isDark ? "border-white/10" : "border-[#ADBC9F]/70"
              }`}>
                {/* Header row */}
            ...
            {rightTab === "explorer" && currentNode && currentNode.children.length > 0 && (
              <div className={`px-4 py-2 border-b ${isDark ? "border-white/10" : "border-[#ADBC9F]/70"}`}>
            ...
            <div className="px-2 pb-4 max-h-[60vh] overflow-y-auto">
              {explorerLoading ? (
                <div className="flex items-center justify-center py-8">
                  ...
                  <span className={`ml-2 text-sm ${isDark ? "text-white/40" : "text-[#436850]"}`}>Loading moves…</span>
                </div>
              ) : explorerMoves.length === 0 ? (
                <div className={`text-center py-8 text-sm ${isDark ? "text-white/30" : "text-[#436850]"}`}>
                ...
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium border transition-colors ${
                    isDark
                      ...
                      : "border-[#ADBC9F] text-[#12372A]/85 hover:bg-[#FBFADA]"
                  }`}
                >
                  Back to Builder
                </button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className={`w-full max-w-2xl rounded-2xl shadow-2xl ${
            ...
            <div className="px-6 py-4">
              <p className={`text-sm mb-3 ${isDark ? "text-white/60" : "text-[#436850]"}`}>
              ...
              <textarea
                ...
                className={`w-full text-xs font-mono rounded-xl p-3 resize-none outline-none ${
                  isDark
                    ...
                    : "bg-[#FBFADA]/70 text-[#12372A] border border-[#ADBC9F]"
                }`}
              />
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className={`w-full max-w-2xl rounded-2xl shadow-2xl ${
            ...
            <div className="px-6 py-4 space-y-4">
              {/* File picker */}
              <div>
                <label className={`block text-sm font-medium mb-1.5 ${isDark ? "text-white/70" : "text-[#12372A]/85"}`}>
                  Upload a .pgn file
                </label>
                <div
                  ...
                  className={`flex items-center gap-3 px-4 py-3 rounded-xl border-2 border-dashed cursor-pointer transition-colors ${
                    isDark
                      ...
                      : "border-[#ADBC9F] hover:border-emerald-500 text-[#436850] hover:text-[#436850]"
                  }`}
                >
                  <Upload size={18} />
                ...
                <textarea
                  ...
                  className={`w-full text-xs font-mono rounded-xl p-3 resize-none outline-none ${
                    isDark
                      ...
                      : "bg-[#FBFADA]/70 text-[#12372A] border border-[#ADBC9F] placeholder:text-[#436850]/60"
                  }`}
                />
              </div>
              ...
              {pgnImportPreview && (
                <div>
                  <label className={`block text-sm font-medium mb-2 ${isDark ? "text-white/70" : "text-[#12372A]/85"}`}>
                    Import mode
                  </label>
                  <div className="flex gap-3">
                  ...
                  <p className={`text-xs mt-1.5 ${isDark ? "text-white/40" : "text-[#436850]"}`}>
