      ...
      {game.status === "pending" && game.blackId === currentUserId && (
        <div className="flex gap-2 p-3">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-1.5 rounded-xl bg-[#436850] hover:bg-[#245a41] text-white text-xs font-semibold py-2 transition"
          >
            ...
            <div className="border-b border-white/10 bg-white/5 p-3 space-y-1">
              ...
              {availableMembers.length === 0 ? (
                ...
                availableMembers.map((m) => (
                  ...
                  >
                    <div className="w-8 h-8 rounded-full bg-[#436850] flex items-center justify-center text-white text-xs font-bold flex-shrink-0">
                      ...
                      <div key={msg.id} className={`flex ${isMe ? "justify-end" : "justify-start"}`}>
                        <div
                          className={`max-w-[70%] px-4 py-2.5 rounded-2xl text-sm ${
                            isMe
                              ? "bg-[#436850] text-white rounded-br-sm"
              ...
              <div className="px-5 py-3 border-t border-white/10 bg-[#0d1f12]/80">
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="w-10 h-10 rounded-2xl bg-[#436850] hover:bg-[#245a41] flex items-center justify-center transition disabled:opacity-40"
                  >
