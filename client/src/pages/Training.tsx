    ...
    <div className={`relative min-h-screen ${isDark ? "bg-[#0a1409]" : "bg-[#f8faf8]"}`}>
      ...
      <div className="max-w-5xl mx-auto px-4 pt-32 pb-24">
        ...
        <div className={`mt-10 rounded-2xl border border-dashed p-5 text-center ${
          isDark ? "border-white/08 bg-white/02" : "border-[#ADBC9F] bg-[#FBFADA]/70/50"
        }`}>
          <div className="flex items-center justify-center gap-2 mb-1.5">
            <Brain className={`w-4 h-4 ${isDark ? "text-white/20" : "text-[#436850]/70"}`} />
            <Zap className={`w-4 h-4 ${isDark ? "text-white/20" : "text-[#436850]/70"}`} />
          </div>
          <p className={`text-sm font-medium mb-0.5 ${isDark ? "text-white/55" : "text-[#436850]"}`}>
