        ...
        <div className="w-full max-w-[80vh] mx-auto">
          ...
          <div className="flex items-center justify-between mb-4 px-2">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-[#12372A] border border-white/10 flex items-center justify-center font-bold text-sm">
          ...
          <div className="flex items-center justify-between mt-4 px-2">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-white/90 border border-white/20 flex items-center justify-center font-bold text-sm text-[#12372A]">
          ...
          <div className="mt-3 bg-black/80 backdrop-blur-lg rounded-xl border border-white/10 overflow-hidden">
            ...
            <div className="flex items-center justify-between px-5 py-2.5">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="w-4 h-4 rounded-full bg-[#12372A] border border-white/15 flex-shrink-0" />
              </div>
            </div>
            {/* Result bar */}
            {broadcast.result && broadcast.result !== "*" && (
      ...
      <div className="flex-1 flex items-stretch min-h-0">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-8 py-4 gap-3">
          ...
          <div className="w-full max-w-[min(72vh,680px)] flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-[#12372A] border-2 border-white/10 flex items-center justify-center font-bold text-lg">
                {broadcast.blackPlayerName.charAt(0).toUpperCase()}
              </div>
              <div>
          ...
          <div className="w-full max-w-[min(72vh,680px)] flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-white/90 border-2 border-white/20 flex items-center justify-center font-bold text-lg text-[#12372A]">
                {broadcast.whitePlayerName.charAt(0).toUpperCase()}
              </div>
              <div>
